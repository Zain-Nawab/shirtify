...
<div class="row mt-4 mb-4 g-4">
    <div class="card mb-4">
        <div class="container">
            <h2 class="text-center m-2">Add New Shirt</h2>
            ...
            <form id="createForm" action="{{ route('admin.products.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    <label for="category_id" class="form-label" style="font-weight: 650">Category</label>
                ...
                <div class="row ">
                    <div class="mb-3 col-md-6">
                        <label for="name" class="form-label" style="font-weight: 650">Shirt Name</label>
                    ...
                    <div class="mb-3 col-md-6">
                        <label for="slug" class="form-label" style="font-weight: 650">Slug</label>
                ...
                <div class="mb-3">
                    <label for="description" class="form-label" style="font-weight: 650">Description</label>
                ...
                <div class="row ">
                    <div class="mb-3 col-md-6">
                        <label for="price" class="form-label" style="font-weight: 650">Price (₨)</label>
                    ...
                    <div class="mb-3 col-md-6">
                        <label for="discounted_price" class="form-label" style="font-weight: 650">Discounted Price (₨)</label>
                ...
                <div class="row">
                    <div class="mb-3 col-md-6">
                        <label for="stock" class="form-label" style="font-weight: 650">Stock</label>
                    ...
                    <div class="mb-3 col-md-6">
                        <label for="size" class="form-label" style="font-weight: 650">Size</label>
                ...
                <div class="row">
                    <div class="mb-3 col-md-6">
                        <label for="color" class="form-label" style="font-weight: 650">Color</label>
                ...
                <div class="mb-3 ">
                    <label for="image_path" class="form-label" style="font-weight: 650">Shirt Image</label>
                ...
                <button type="submit" class="btn btn-primary mb-3" style="font-weight: 500">Add Shirt</button>
            </form>
        </div>
    </div>
</div>
